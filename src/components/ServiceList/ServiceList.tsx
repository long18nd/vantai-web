...
const ListService = [
  {
    ...
    content: "Vận chuyển ô tô Bắc Nam bằng tàu hỏa là một trong những dịch vụ chủ lực của Quy Long Logistics...",
    img: vc_oto,
  },
  {
  ...
  },
  {
    ...
    content: "Dịch vụ chuyển nhà trọn gói Bắc Nam là một trong những dịch vụ chủ lực của Quy Long Logistics...",
    img: vc_nha,
  },
];
    ...
    <div className="py-12 flex flex-col items-center gap-12 bg-gray-50">
      ...
      <div className="flex flex-wrap justify-center items-start gap-x-6 gap-y-8">
        {ListService.map((card, index) => (
          <div key={index}>
            <ServiceCard content={card.content} img={card.img} title={card.title} />
          </div>
        ))}
      </div>
    </div>
