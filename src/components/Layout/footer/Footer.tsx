      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              Email:{" "}
              <a
                href="mailto:vantaibacnam.vn@gmail.com"
                className="text-blue-300"
              >
                vantaibacnam.vn@gmail.com
              </a>
            </li>
            <li>
              Website:{" "}
              <a href="https://vantaibacnam.vn" className="text-blue-300">
                vantaibacnam.vn
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="/cho-thue-xe-tai" className="hover:text-red-400">
                Cho thuê xe tải chở hàng
              </a>
            </li>
            <li>
              <a href="/dich-vu-nang-ha" className="hover:text-red-400">
                Dịch vụ nâng hạ hàng hóa
              </a>
            </li>
            <li>
              <a href="/gui-hang-di-tinh" className="hover:text-red-400">
                Gửi hàng đi các tỉnh
              </a>
            </li>
          </ul>
        </div>
