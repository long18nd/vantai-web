    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-6 text-sm font-medium text-gray-700">
          ...
          <a href="/bang-gia" className="hover:text-blue-600">
            Bảng giá
          </a>
      ...
      {menuOpen && (
        <nav className="md:hidden bg-white px-4 py-2 shadow">
          <ul className="space-y-3 text-sm font-medium text-gray-700">
            <li>
              <a href="/public" className="block hover:text-blue-600">
                Trang chủ
              </a>
            </li>
            <li>
              <a href="/gioi-thieu" className="block hover:text-blue-600">
                Giới thiệu
              </a>
            </li>
            <li>
              <a href="/dich-vu" className="block hover:text-blue-600">
                Dịch vụ
              </a>
            </li>
            <li>
              <a href="/bang-gia" className="block hover:text-blue-600">
                Bảng giá
              </a>
            </li>
            <li>
              <a href="/tin-tuc" className="block hover:text-blue-600">
                Tin tức
              </a>
            </li>
            <li>
              <a href="/lien-he" className="block hover:text-blue-600">
                Liên hệ
              </a>
            </li>
          </ul>
