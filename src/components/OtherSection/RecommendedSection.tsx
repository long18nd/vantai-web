...
const features = [
  {
    ...
    content: (
      <>
        ...
        <p><strong>Nha Trang</strong> – nhanh hơn 6 giờ</p>
        <p><strong>Đà Nẵng</strong> – nhanh hơn 12 giờ</p>
        <p><strong>Hà Nội</strong> – nhanh hơn 24 giờ</p>
      </>
    ),
  },
  {
...
const RecommendedSection = () => {
  return (
    <div id="recommended" className="h-auto py-16 px-6 bg-[#163C63] text-white text-sm">
